...
const CartItem = ({ item }) => {
    ...
    return <div className="flex w-full justify-between items-center h-[120px] border-b mb-4">
        {/* image */}
        <div className="w-[110px] h-[110px] relative">
            <Image src={urlFor(item.images[0]).url()} fill priority sizes='(max-width: 110px) 110px, 110p' className="object-contain" alt=""/>
        </div>
